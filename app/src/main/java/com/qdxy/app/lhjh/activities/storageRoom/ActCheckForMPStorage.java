...
public class ActCheckForMPStorage extends ActTempTabActivity{

    @Override
    protected void findViews() {
        initToolbar("毛坯入库抽检列表");
    ...
    protected void bindValues() {
        ...
        bundlePrdUnchecked.putSerializable("type", CommonType.MAO_PI_STORAGE_CJ);
        ...
        bundlePrdChecked.putSerializable("type",CommonType.MAO_PI_STORAGE_CJ);
