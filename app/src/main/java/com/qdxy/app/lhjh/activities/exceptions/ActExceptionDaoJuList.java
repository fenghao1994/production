...
public class ActExceptionDaoJuList extends TempActivity{
...
//        Debug.info(TAG,"patchCode="+patchCode);
        ...
        titleList.add("未处理");
        Fragment fragPrdUnchecked = new FragExceptionDaoJuList();
        ...
        titleList.add("已处理");
        Fragment fragPrdChecked = new FragExceptionDaoJuList();
