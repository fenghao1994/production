...
//        Debug.info(TAG,"patchCode="+patchCode);
        ...
        titleList.add("未读");
        Fragment fragPrdUnchecked = new FragMessageCenter();
        Bundle bundlePrdUnchecked = new Bundle();
        bundlePrdUnchecked.putBoolean("read", false);
        fragPrdUnchecked.setArguments(bundlePrdUnchecked);
        fragmentList.add(fragPrdUnchecked);

        titleList.add("已读");
        Fragment fragPrdChecked = new FragMessageCenter();
        Bundle bundlePrdChecked = new Bundle();
        bundlePrdChecked.putBoolean("read", true);
