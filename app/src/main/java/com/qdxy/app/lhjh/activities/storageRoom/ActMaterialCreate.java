...
public class ActMaterialCreate extends TempActivity {
    ...
    protected void findViews() {
        initToolbar("创建辅料领用订单");
        mTvName.setText("辅料列表");
        mTvAdd.setText("添加辅料");
    }
        ...
        switch (v.getId()) {
            case R.id.storage_commit_btn:
                ...
                if (mRequestData.getProductionLineId() == -1) {
                    ...
                    showSnackBar("请添加辅料", 2, Snackbar.LENGTH_LONG);
                } else {

                    mPre.orderCreate_roughcast(mRequestData);
                }
                break;
            case R.id.tv_add:
                //添加辅料
    ...
    private void showCreateMaterialDialog() {
        ...
        new AlertDialog.Builder(this).setView(rootView).setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (mModleId == -1) {
                    showSnackBar("没有辅料数据", 2, Snackbar.LENGTH_LONG);
            ...
            public void bindItemValues(TempRVHolder holder, final RequestBodyMaterial.ItemsBody itemsBody) {
                ...
                holder.setOnClickListener(R.id.img_delete, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        new AlertDialog.Builder(ActMaterialCreate.this).setTitle("是否确认删除该辅料?").setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
