...
public  class FragTempList extends TempFragment{
        ...
        mPrePullable = new TempPullablePreDefault<RespStorageList>(new TempPullableViewI<RespStorageList>() {
            ...
            public Call<RespStorageList> createObservable(int queryPage, int querysize, int currentPage) {
                int tempType=0;
                    ...
                    return TempRemotAPIConnecter.INSTANCE.createRemoteApi(TempAPI.class).applyList(tempType,mIsHandle,queryPage);
    ...
    protected void OnViewClicked(View v) {
        switch (v.getId()) {
            case R.id.fab:
                if (mType==CommonType.MAO_PI_STORAGE_SQ){
                    Intent tempIntent = new Intent(getActivity(), ActMPStorageCreate.class);
