...
public class ActMaoPiReceiver extends ActTempTabActivity{
    @Override
    ...
    protected void bindValues() {
        ...
        bundlePrdUnchecked.putSerializable("type", CommonType.MAO_PI_LY);
        ...
        bundlePrdChecked.putSerializable("type",CommonType.MAO_PI_LY);
