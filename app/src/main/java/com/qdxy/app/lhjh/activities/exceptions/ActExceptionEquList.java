...
public class ActExceptionEquList extends TempActivity {
...
//        Debug.info(TAG,"patchCode="+patchCode);
        ...
        titleList.add("未处理");
        Fragment fragPrdUnchecked = new FragExceptionEquList();
        ...
        titleList.add("已处理");
        Fragment fragPrdChecked = new FragExceptionEquList();
