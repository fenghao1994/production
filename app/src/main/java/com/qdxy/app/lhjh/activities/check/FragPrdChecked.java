...
public class FragPrdChecked extends TempFragment{
    ...
    protected void bundleValues(View view, @Nullable Bundle savedInstanceState) {
        EventBus.getDefault().register(FragPrdChecked.this);
        ...
        pullablePreDefault = new TempPullablePreDefault<RespCheckPrdList>(pullableViewI) {
            ...
            public Call<RespCheckPrdList> createObservable(int queryPage, int querysize, int currentPage) {
                return TempRemotAPIConnecter.INSTANCE.createRemoteApi(TempAPI.class).requestRandomCheckPrdList(patchCode, true, queryPage + "");
            }
        };
    ...
    public void onDestroy() {
        EventBus.getDefault().unregister(FragPrdChecked.this);
        super.onDestroy();
    }
