...
public class ActAlarmManagement extends TempActivity{
    private final String TAG ="ActAlarmManagement";
...
//                Debug.info("获取到产品型号数据" + data.toString());
    ...
    private void initTabs(TabLayout tabLayout, ViewPager viewPager,List<RespProductLines.DataBean> dataList) {
        ...
        if (dataList==null||dataList.size()==0){
            ...
            Fragment fragPrdUnchecked = new FragAlarmMangment();
