...
public class ActApplyForMPStorage extends ActTempTabActivity{

    @Override
    protected void findViews() {
        initToolbar("毛坯入库申请列表");
    ...
    protected void bindValues() {
        ...
        bundlePrdUnchecked.putSerializable("type", CommonType.MAO_PI_STORAGE_SQ);
        ...
        bundlePrdChecked.putSerializable("type",CommonType.MAO_PI_STORAGE_SQ);
