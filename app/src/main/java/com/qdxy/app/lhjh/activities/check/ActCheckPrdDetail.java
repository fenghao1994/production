...
public class ActCheckPrdDetail extends TempActivity implements ViewCheckI {
    ...
    @Bind(R.id.act_prd_check_detail_code)
    TextView act_prd_check_detail_code;
    @Bind(R.id.act_prd_check_person_name_text)
    TextView act_prd_check_person_name_text;
    @Bind(R.id.act_prd_check_self_listView)
    TempMyListView act_prd_check_self_listView;
    @Bind(R.id.act_prd_check_random_listView)
    TempMyListView act_prd_check_random_listView;
    ...
    @Bind(R.id.act_prd_check_commit_btn)
    AppCompatButton act_prd_check_commit_btn;
    @Bind(R.id.act_prd_check_random_operation_frame)
    LinearLayout act_prd_check_random_operation_frame;
