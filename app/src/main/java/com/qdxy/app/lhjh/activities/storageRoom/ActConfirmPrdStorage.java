...
public class ActConfirmPrdStorage extends TempActivity{
    ...
    protected void setListeners() {
        mPrePullable = new TempPullablePreDefault<RespApprovePrdList>(new TempPullableViewI<RespApprovePrdList>() {
            ...
            public Call<RespApprovePrdList> createObservable(int queryPage, int querysize, int currentPage) {
                return TempRemotAPIConnecter.INSTANCE.createRemoteApi(TempAPI.class).requestProductApplyList(2, false, queryPage);
            }
        };
    }
...
//                mAdapter.notifyDataSetChanged();
                Intent startDetail = new Intent(ActConfirmPrdStorage.this,ActApplyPrdDetail.class);
                startDetail.putExtra("id",o.getId());
                startDetail.putExtra("type",2);
