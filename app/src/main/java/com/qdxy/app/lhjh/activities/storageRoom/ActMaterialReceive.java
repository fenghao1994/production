...
public class ActMaterialReceive extends ActTempTabActivity{
...
//                Intent tempIntent = new Intent(ActMaterialReceive.this, ActMaterialCreate.class);
...
//        });
    ...
    protected void bindValues() {
        ...
        bundlePrdUnchecked.putSerializable("type", CommonType.MATERIAL_SQ);
        ...
        bundlePrdChecked.putSerializable("type",CommonType.MATERIAL_SQ);
