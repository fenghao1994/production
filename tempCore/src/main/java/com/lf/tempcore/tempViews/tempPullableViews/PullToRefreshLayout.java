...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	private void initView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		reverseUpAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.temp_reverse_up_anim);
		reverseDownAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.temp_reverse_down_anim);
		refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.temp_rotating_anim);
		// 添加匀速转动动画
		...
		defaultRefreshView = inflater.inflate(R.layout.temp_refresh_head, this,
				false);
		refreshView = defaultRefreshView;
		defaultLoadmoreView = inflater.inflate(R.layout.temp_load_more, this, false);
	...
	public void refreshFinish(int refreshResult)
	{
		...
		case SUCCEED:
			...
			if (null == customRefreshView)
			{
				...
				if (refreshStateImageView!=null)
				refreshStateImageView.setBackgroundResource(R.mipmap.temp_refresh_succeed);
			}
			break;
		case FAIL:
		default:
			...
			if (null == customRefreshView)
			{
				...
				if (refreshStateImageView!=null)
				refreshStateImageView.setBackgroundResource(R.mipmap.temp_refresh_failed);
			}
			break;
		}
		if (pullDownY > 0)
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		case SUCCEED:
			...
			if (null == customLoadmoreView)
			{
				...
				loadStateImageView
						.setBackgroundResource(R.mipmap.temp_load_succeed);
			}
			break;
		case FAIL:
		default:
			...
			if (null == customLoadmoreView)
			{
				...
				loadStateImageView
						.setBackgroundResource(R.mipmap.temp_load_failed);
			}
			break;
		}
		if (pullUpY < 0)
